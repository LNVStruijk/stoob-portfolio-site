        ...
        <div className={styles.flexRow}>
          ...
          >
            <a
              ...
              rel='noreferrer'
            >
              <Image alt='' src={Floorplan} width='400' height='868' />
              {/* next.js  */}
            </a>
          </div>
        </div>
