    ...
    <div className={styles.container}>
      <div className={styles.imageContainer}>
        {props.image === 'Featured' ? (
          <Image src={GalleryViewIcon} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'Posters' ? (
          <Image src={PostersIcon} width={iconSize} height={iconSize} alt=''/>
        ) : props.image === 'AboutMe' ? (
          <Image src={AboutMeIcon} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'ContactMe' ? (
          <Image src={ContactMeIcon} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'Typography' ? (
          <Image src={TypographyIcon} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'Paintings' ? (
          <Image src={PaintingsIcon} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'Doom' ? (
          <Image src={DoomLaugh} width={iconSize} height={iconSize} alt='' />
        ) : props.image === 'OtherWorks' ? (
          <Image src={OtherWorksIcon} width={iconSize} height={iconSize} alt='' />
        ) :null }
      </div>
